...
TYPE PARTICLE_CLASS_TYPE
   ...
   REAL(EB) :: DENSITY,TMP_V=-1._EB,TMP_MELT=-1._EB,FTPR,HEAT_OF_COMBUSTION,ADJUST_EVAPORATION, &
               ...
               TMP_INITIAL,SIGMA,GAMMA_VAP,VERTICAL_VELOCITY,HORIZONTAL_VELOCITY, &
   ...
   REAL(EB), POINTER, DIMENSION(:) :: R_CDF,CDF,CHILD_R_CDF,CHILD_CDF,W_CDF,KWR
   REAL(EB), POINTER, DIMENSION(:,:) :: WQABS,WQSCA
   REAL(EB) :: H_V(5000)=-1._EB,C_P(5000)=-1._EB,C_P_BAR(5000)=-1._EB,H_L(5000), &
               H_V_REFERENCE_TEMPERATURE=-1._EB,H_V_CORRECTOR=0._EB
   REAL(EB), POINTER, DIMENSION(:,:) :: ORIENTATION
   INTEGER :: SAMPLING,SPEC_INDEX,N_QUANTITIES,QUANTITIES_INDEX(10),EVAP_INDEX=0,RGB(3), &
              SURF_INDEX=-1,DRAG_LAW=1,DEVC_INDEX=0,CTRL_INDEX=0,PROP_INDEX=-1,N_SPLIT=1,SPLIT_PART_INDEX=0
...
TYPE MATERIAL_TYPE
   ...
   REAL(EB), DIMENSION(1:MAX_REACTIONS) :: TMP_REF,TMP_IGN,TMP_THR,RATE_REF
   REAL(EB), DIMENSION(1:MAX_REACTIONS) :: NU_RESIDUE,NU_FUEL,NU_WATER,A,E,H_R,N_S,N_T,HEATING_RATE,PYROLYSIS_RANGE, &
                                           HEAT_OF_COMBUSTION
   REAL(EB), DIMENSION(1:MAX_REACTIONS,1:MAX_SPECIES) :: NU_GAS,ADJUST_BURN_RATE
...
TYPE GEOMETRY_TYPE
   ...
   LOGICAL :: TRANSLATE=.FALSE.,ROTATE=.FALSE.,HOLE=.FALSE.,TWO_SIDED=.FALSE.,IBM_ALLOCATED=.FALSE.
   INTEGER :: ISHAPE
...
TYPE SLICE_TYPE
   INTEGER :: I1,I2,J1,J2,K1,K2,INDEX,INDEX2=0,SPEC_INDEX=0,PART_INDEX=0,VELO_INDEX=0
   LOGICAL :: RLE
...
TYPE PROFILE_TYPE
   REAL(EB) :: X,Y,Z,P0=0._EB,PX(3)=0._EB,PXX(3,3)
...
TYPE INITIALIZATION_TYPE
   REAL(EB) :: TEMPERATURE,DENSITY,MASS_FRACTION(MAX_SPECIES),X1,X2,Y1,Y2,Z1,Z2,MASS_PER_VOLUME,MASS_PER_TIME,DT_INSERT, &
               X0,Y0,Z0,U0,V0,W0,RADIUS,VOLUME
   REAL(EB), POINTER, DIMENSION(:) :: PARTICLE_INSERT_CLOCK
   INTEGER  :: PART_INDEX=0,NUMBER_INITIAL_DROPLETS,WALL_INDEX_START=-1,LU_DROPLET,PROF_INDEX=0
   LOGICAL :: ADJUST_DENSITY=.FALSE.,ADJUST_TEMPERATURE=.FALSE.,POINTWISE_DROPLET_INIT=.FALSE.
   CHARACTER(30) :: SHAPE,PROF_ID
...
TYPE DUCT_TYPE
   ...
   REAL(EB) :: ROUGHNESS,LENGTH, DIAMETER, AREA_INITIAL, AREA, CP_D, RHO_D,TMP_D,LOSS(2)=0._EB,VEL(4)=0._EB,RSUM_D=0._EB,&
               DP_FAN=0._EB,TOTAL_LOSS = 0._EB,COIL_Q,VOLUME_FLOW=1.E6_EB,VOLUME_FLOW_INITIAL=1.E6_EB,X(2),Y(2),Z(2),TAU=-1._EB
   ...
   LOGICAL :: ROUND = .TRUE.,SQUARE = .FALSE.,DAMPER = .FALSE.,DAMPER_OPEN = .TRUE.,FAN_OPERATING=.TRUE.,COIL_OPERATING=.TRUE.,&
              FIXED=.FALSE.,REVERSE=.FALSE.,UPDATED
